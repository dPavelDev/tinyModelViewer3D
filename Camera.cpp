...
void Camera::setFixedCenter(bool isFixedCenter)
{
    _isFixedCenter = isFixedCenter;
}
...
void Camera::setRotationSpeedFixed(bool isRotationSpeedFixed)
{
    _rotationSpeedFixed = isRotationSpeedFixed;
}
...
void Camera::alignUp(const QVector3D alignVector)
{
    this->setUp(alignVector);
